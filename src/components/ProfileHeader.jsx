  ...
  return (
    <header className="flex space-x-3 px-[8.5px]">
      ...
      <aside className="grow space-y-1">
        <h1 className="text-white font-medium text-[15px] hidden lg:block">
          Nishyan
        </h1>
        <p className=" text-[13px] leading-4 text-white/80 underline hover:cursor-pointer w-fit hidden md:block">
          Visit store
        </p>
      </aside>
      <svg
        className="self-center hover:cursor-pointer hidden md:block"
