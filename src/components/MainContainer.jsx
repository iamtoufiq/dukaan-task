...
const MainContainer = () => {
  return (
    <div className="grow">
      <Navbar />
      <main className=" p-3 md:p-8 space-y-6 bg-[#fafafa]">
        ...
        <aside className=" space-x-3 flex justify-between md:justify-start">
          <span className="py-1.5 px-4 bg-background-light rounded-full text-sm font-medium text-[#808080]">
            Payouts {"(22)"}
          </span>
          <span className="py-1.5 px-4 bg-secondary rounded-full text-sm font-medium text-white">
            Refunds {"(6)"}
          </span>
        </aside>
        <Table />
